...
def getIntermediatev2woGTSamplingFusionDataset(cls):
    """
    没有GT Sampling 但是有其他的数据增强方法
    cls: the Basedataset.
    """
    class IntermediateV2woGTSamplingFusionDataset(cls):
        ...
        def get_item_single_car(self, selected_cav_base, ego_cav_base):
            ...
            if self.load_lidar_file or self.visualize:
                ...
                # data augmentation TODO 写到这里 没结束，后续再接着改 2025-01-11
    ...
    return IntermediateV2woGTSamplingFusionDataset
