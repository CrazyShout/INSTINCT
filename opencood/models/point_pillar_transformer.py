...
class PointPillarTransformer(nn.Module):
    def __init__(self, args):
        ...
        if is_resnet:
            ...
            self.backbone = BaseBEVBackbone(args['base_bev_backbone'], 64) # or you can use ResNetBEVBackbone, which is stronger        # used to downsample the feature map for efficient computation
